...
declare module "mdb-react-ui-kit" {
  ...
  interface BadgeProps
    extends Omit<React__default.AllHTMLAttributes<HTMLElement>, "color"> {
    color?:
      | "primary"
      | "secondary"
      | "success"
  ...
  interface ListGroupItemProps
    extends Omit<React__default.AllHTMLAttributes<HTMLLIElement>, "action"> {
    active?: boolean;
    action?: boolean;
    color?:
      | "primary"
  ...
  interface TooltipProps
    extends Omit<React.AllHTMLAttributes<HTMLElement>, "title"> {
  ...
  declare type TypographyProps = Omit<
  ...
  interface PaginationProps
    extends Omit<React.AllHTMLAttributes<HTMLElement>, "size" | "start"> {
    center?: boolean;
    end?: boolean;
    start?: boolean;
    size?: "lg" | "sm";
  ...
  interface AccordionItemProps
    extends React__default.HTMLAttributes<HTMLElement> {
  ...
  declare type ValidationItemProps =
    React__default.AllHTMLAttributes<HTMLElement> & {
      tag?: React__default.ComponentProps<any>;
      invalid?: boolean;
